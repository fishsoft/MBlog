...
!function (t, e) {
    ...
    return function (t) {
        ...
        o.VERSION = "2.6.2", o.support = {}, o.support.transition = function () {
            ...
            i = i || {}, n.fn[t] = function (s) {
                var a, r = Array.prototype.slice.call(arguments, 0), l = r.slice(1), c = this.each(function () {
                    var c = n(this), h = "amui." + t, u = i.dataOptions || "data-am-" + t, d = c.data(h),
        ...
        function E(t, e, i) {
            var n = i.pointers.length, o = i.changedPointers.length, s = e & Dt && n - o === 0,
                a = e & (At | $t) && n - o === 0;
        ...
        var at, rt = i(1), lt = i(2), ct = ["", "webkit", "Moz", "MS", "ms", "o"], ht = document.createElement("div"),
            ut = "function", dt = Math.round, pt = Math.abs, mt = Date.now;
        ...
        var ft = a(function (t, e, i) {
                ...
                return ft(t, e, !0)
            }, "merge", "Use `assign`."), gt = 1, wt = /mobile|tablet|ip(ad|hone|od)|android/i,
            yt = "ontouchstart" in window, bt = void 0 !== y(window, "PointerEvent"),
            Tt = yt && wt.test(navigator.userAgent), xt = "touch", Ct = "pen", Et = "mouse", St = "kinect", kt = 25,
            Dt = 1, Ft = 2, At = 4, $t = 8, Mt = 1, Pt = 2, Nt = 4, It = 8, Ot = 16, Lt = Pt | Nt, _t = It | Ot,
            zt = Lt | _t, Rt = ["x", "y"], qt = ["clientX", "clientY"];
        x.prototype = {
            handler: function () {
            }, init: function () {
        ...
        var Bt = {pointerdown: Dt, pointermove: Ft, pointerup: At, pointercancel: $t, pointerout: $t},
            Ut = {2: xt, 3: Ct, 4: Et, 5: St}, Xt = "pointerdown", Yt = "pointermove pointerup pointercancel";
        window.MSPointerEvent && !window.PointerEvent && (Xt = "MSPointerDown", Yt = "MSPointerMove MSPointerUp MSPointerCancel"), r(_, x, {
            handler: function (t) {
                var e = this.store, i = !1, n = t.type.toLowerCase().replace("ms", ""), o = Bt[n],
                    s = Ut[t.pointerType] || t.pointerType, a = s == xt, r = v(e, t.pointerId, "pointerId");
        ...
        var jt = {touchstart: Dt, touchmove: Ft, touchend: At, touchcancel: $t}, Zt = "touchstart",
        ...
        var Jt = {touchstart: Dt, touchmove: Ft, touchend: At, touchcancel: $t},
        ...
        var Qt = y(ht.style, "touchAction"), te = void 0 !== Qt, ee = "compute", ie = "auto", ne = "manipulation",
            oe = "none", se = "pan-x", ae = "pan-y";
        V.prototype = {
            set: function (t) {
        ...
        s.DEFAULTS = {
            ...
            var i = this.$element, s = "disabled", a = i.data(), r = this.options, l = i.is("input") ? "val" : "html",
        ...
        a.DEFAULTS = {toggle: !0}, a.prototype.open = function () {
            ...
            var e, i = o(this), a = s.utils.options(i.attr("data-am-collapse")),
                r = a.target || t.preventDefault() || (e = i.attr("href")) && e.replace(/.*(?=#[^\s]+$)/, ""), l = o(r),
                c = l.data("amui.collapse"), h = c ? "toggle" : a, u = a.parent, d = u && o(u);
        ...
        a.DEFAULTS = {
            ...
            if (this.$dropdown.length) {
                var t = this.$dropdown, e = t.offset(), i = t.outerWidth(), o = this.$boundary.width(),
        ...
        (function (e) {
            ...
            n.flexslider = function (t, i) {
                ...
                var a, r = o.vars.namespace,
                    ...
                    h = "click touchend MSPointerUp keyup", u = "", d = "vertical" === o.vars.direction,
                    p = o.vars.reverse, m = o.vars.itemWidth > 0, f = "fade" === o.vars.animation,
                    v = "" !== o.vars.asNavFor, g = {};
            ...
            version: "5.1.3", _init: function () {
                ...
                if (this.enabled && a.eventType[t.type] === this.initiated) {
                    ...
                    var e, i, n = (t.changedTouches ? t.changedTouches[0] : t, a.getTime() - this.startTime),
                        ...
                        l = Math.abs(s - this.startY), c = 0, h = "";
        ...
        c.DEFAULTS = {
            ...
            var t = this.options, e = this, i = this.$element, n = i.find(".am-modal-prompt-input"),
                s = i.find("[data-am-modal-confirm]"), a = i.find("[data-am-modal-cancel]"), r = function () {
                    var t = [];
        ...
        c.DEFAULTS = {duration: 300, effect: "overlay"}, c.prototype.open = function (t) {
            ...
            if (i.length && !i.hasClass("am-active")) {
                var n = this.options.effect, s = o("html"), l = o("body"), c = i.find(".am-offcanvas-bar").first(),
            ...
            t.preventDefault();
            var e = o(this), i = s.utils.parseOptions(e.data("amOffcanvas")),
            ...
            e.prototype = {
                defaults: {
                    ...
                    var e = (this.zoomFactor - 1) * this.getContainerX(),
                        i = (this.zoomFactor - 1) * this.getContainerY(), n = Math.max(e, 0), o = Math.max(i, 0),
                        s = Math.min(e, 0), a = Math.min(i, 0);
                    ...
                    this.updatePlaned || (this.updatePlaned = !0, setTimeout(function () {
                        ...
                        var t = this.getInitialZoomFactor() * this.zoomFactor, e = -this.offset.x / t,
                            ...
                            o = "scale(" + t + ", " + t + ") translate(" + e + "px," + i + "px)", s = function () {
        ...
        a.DEFAULTS = {
            ...
            if (e && e.length) {
                var i = e.outerWidth(), n = e.outerHeight(), o = e.find(".am-popover-caret"),
                    a = o.outerWidth() / 2 || 8, r = n + 8, l = t.outerWidth(), c = t.outerHeight(), h = t.offset(),
                    u = t[0].getBoundingClientRect(), d = s.height(), p = s.width(), m = 0, f = 0, v = 0, g = 2,
                    w = "top";
                e.css({
                    left: "",
                    top: ""
        ...
        var n = i(2), o = function () {
            ...
            l.configure = function (t) {
                ...
                var n, s = i.querySelector(c.barSelector), a = t ? "-100" : e(l.status || 0),
        ...
        "use strict";
        var n = i(1), o = i(2), s = i(17), a = i(3), r = o.support.animation, l = o.support.transition,
            c = function (t, e) {
        ...
        s.DEFAULTS = {
            ...
            var t = this.$element, e = this.options, i = o.utils.isInView(t, e),
        ...
        var n = i(1), o = i(2), s = o.utils.rAF, a = o.utils.cancelAF, r = !1, l = function (t, e) {
            ...
            e = e || {};
            var h, u, d, p = n(t), m = parseInt(e.position) || l.DEFAULTS.position, f = p.scrollTop(), v = f, g = m - f,
        ...
        s.DEFAULTS = {
            ...
            var i = this.options, n = this.$element, s = i.animation ? " am-animation-" + i.animation : "",
                a = function () {
                    n.css({
                        position: "",
                        top: "",
        ...
        function n(t) {
            ...
            return this.each(function () {
                var n = o(this), a = n.is(".am-tabs") && n || n.closest(".am-tabs"), r = a.data("amui.tabs"),
        ...
        c.DEFAULTS = {
            ...
            if (t = "number" == typeof t ? this.$navs.eq(i) : o(t), t && t.length && !this.transitioning && !t.parent("li").hasClass(e)) {
                var n = this.$tabNav, s = t.attr("href"), a = /^#.+$/,
                    r = a.test(s) && this.$content.find(s) || this.$tabPanels.eq(i), l = n.find("." + e + " a")[0],
                    c = o.Event("open.tabs.amui", {relatedTarget: l});
        ...
        s.DEFAULTS = {
            ...
            var r = s.attr("pattern") || !1, l = new RegExp(r), c = null, h = null,
            ...
            var d = void 0 !== s.attr("required") && "false" !== s.attr("required"),
                p = parseInt(s.attr("maxlength"), 10), m = parseInt(s.attr("minlength"), 10), f = Number(s.attr("min")),
                v = Number(s.attr("max")), g = this.createValidity({field: s[0], valid: !0});
            ...
            var t = this, e = this.$element, i = this.options, o = e.find(i.allFields).not(i.ignore), s = [], a = !0,
                r = [], l = n([]), c = [], h = !1;
        ...
        function o() {
            var t = document.querySelector(".am-map"), e = 116.331398, i = 39.897445, n = t.getAttribute("data-name"),
                o = t.getAttribute("data-address"), s = t.getAttribute("data-longitude") || e,
                a = t.getAttribute("data-latitude") || i, r = t.getAttribute("data-setZoom") || 17,
                l = t.getAttribute("data-icon"), c = new BMap.Map("bd-map"), h = new BMap.Point(s, a);
        ...
        var a = function () {
            ...
            i.find("a").not(".am-parent>a").on("click", function (t) {
                ...
                var e, i = n(this), o = n('<div class="am-menu-nav-sub-wrap"></div>'), a = 0,
                ...
                l.on("click", function () {
                    ...
                    var s, a = n(this).index() > e, l = n(this)[a ? "next" : "prev"](),
                        h = l.offset() || n(this).offset(), u = i.offset(), d = parseInt(i.css("padding-left"));
        ...
        function n() {
            ...
            if (n.length) {
                var l = o(window), c = o("body"), h = n.find(".am-navbar-nav"), u = n.find("li"), d = u.length,
                    p = h.attr("class") && parseInt(h.attr("class").match(/am-avg-sm-(\d+)/)[1]) || 3, m = 60, f = 16,
                    v = u.filter("[data-am-navbar-share]"), g = u.filter("[data-am-navbar-qrcode]"), w = "am-active",
                    y = o('<ul class="am-navbar-actions"></ul>', {id: s.utils.generateGUID("am-navbar-actions")}),
